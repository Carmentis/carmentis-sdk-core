...
import { StateChecker } from "../../src/blockchain/stateChecker/StateChecker";
import { MicroblockProofEntry } from "../../src/type/valibot/proofs/MicroblockProof"
import { AccountProofEntry } from "../../src/type/valibot/proofs/AccountProof"

const validMicroblockProof: MicroblockProofEntry = {
    "block": {
        "height": 18,
...
const validAccountProof: AccountProofEntry = {
    "block": {
        "height": 36,
...
function cloneMicroblockProof(proof: MicroblockProofEntry): MicroblockProofEntry {
    return JSON.parse(JSON.stringify(proof));
}

function cloneAccountProof(proof: AccountProofEntry): AccountProofEntry {
    return JSON.parse(JSON.stringify(proof));
}
